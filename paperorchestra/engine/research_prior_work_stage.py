...
from paperorchestra.engine.research_prior_work_import import import_prior_work_with_hooks
from paperorchestra.engine.research_registry_io import load_prior_citation_registry
from paperorchestra.engine.research_registry_merge import merge_live_verified_with_prior_registry as _merge_live_verified_with_prior_registry
from paperorchestra.engine.schema_research import PRIOR_WORK_SEED_SCHEMA
...
def import_prior_work(
    ...
    *,
    ...
    return import_prior_work_with_hooks(
        cwd,
        seed_file=seed_file,
        source=source,
        require_complete_metadata=require_complete_metadata,
        ...
        load_prior_work_seed_fn=load_prior_work_seed,
        entries_to_registry_fn=prior_work_entries_to_verified_papers,
        load_prior_registry_fn=load_prior_citation_registry,
        merge_registries_fn=_merge_live_verified_with_prior_registry,
        filter_entries_fn=_filter_prior_work_entries_for_complete_metadata,
        write_rejection_report_fn=_write_prior_work_import_rejection_report,
        write_artifacts_fn=write_prior_work_import_artifacts,
        record_lane_manifest_fn=record_lane_manifest,
    )


__all__ = ["import_prior_work", "research_prior_work"]
