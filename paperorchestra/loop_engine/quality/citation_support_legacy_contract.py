...
def _wrapper_contract_proof_is_trusted(provenance: dict[str, Any]) -> bool:
    ...
    if payload is None or not _contract_points_to_wrapper(payload, contract=contract, wrapper=wrapper):
        return False
