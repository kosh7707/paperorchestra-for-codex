...
def build_quality_source_artifacts(
    *,
    ...
    return {
        ...
        "page_layout_review": getattr(state.artifacts, "latest_page_layout_review_json", None),
        "visual_repair_brief": getattr(state.artifacts, "latest_visual_repair_brief_json", None),
        "visual_repair_candidate": getattr(state.artifacts, "latest_visual_repair_candidate_json", None),
