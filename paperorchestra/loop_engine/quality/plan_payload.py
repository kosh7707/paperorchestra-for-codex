...
def _source_artifacts(context: QualityLoopPlanPayloadInput) -> dict[str, Any]:
    ...
    return {
        ...
        "page_layout_review": getattr(artifacts, "latest_page_layout_review_json", None),
        "visual_repair_brief": getattr(artifacts, "latest_visual_repair_brief_json", None),
        "visual_repair_candidate": getattr(artifacts, "latest_visual_repair_candidate_json", None),
