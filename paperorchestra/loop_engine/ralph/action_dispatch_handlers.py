...
ACTION_HANDLER_REGISTRY: tuple[tuple[frozenset[str], ActionHandler], ...] = (
    ...
    (frozenset(PAGE_LAYOUT_REVIEW_CODES), handle_page_layout_review),
    (frozenset(VISUAL_REPAIR_BRIEF_CODES), handle_visual_repair_brief),
    (frozenset(VISUAL_REPAIR_CANDIDATE_CODES), handle_visual_repair_candidate),
