...
class OrchestraOrchestrator:
    ...
    def inspect_state(self, *, material_path: str | Path | None = None, strict_omx: bool = False) -> OrchestraState:
        return inspect_orchestra_state(self.cwd, material_path=material_path, strict_omx=strict_omx)

    def run_until_blocked(self, *, material_path: str | Path | None = None) -> OrchestratorRunResult:
        return self._result_from_state(run_orchestra_until_blocked(self.cwd, material_path=material_path))
    ...
    def execute_omx_once(
        ...
        *,
        ...
        state = run_orchestra_until_blocked(self.cwd, material_path=material_path)
