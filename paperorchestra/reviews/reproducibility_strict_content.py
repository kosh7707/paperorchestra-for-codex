...
def _strict_validation_report_issues(state, session_artifact_dir: Path | None) -> list[dict[str, Any]]:
...
def _strict_figure_review_issues(state, session_artifact_dir: Path | None) -> list[dict[str, Any]]:
    expected_manuscript_sha = _file_sha256(state.artifacts.paper_full_tex)
