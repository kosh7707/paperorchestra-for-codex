...
SMOKE_CODEX_HOME_PARENT="${PAPERO_SMOKE_CODEX_HOME_PARENT:-$HOME/.cache/paperorchestra/smoke-codex-home}"
mkdir -p "$SMOKE_CODEX_HOME_PARENT"
chmod 700 "$SMOKE_CODEX_HOME_PARENT" 2>/dev/null || true
SMOKE_CODEX_HOME="$(mktemp -d "$SMOKE_CODEX_HOME_PARENT/codex-home.XXXXXX")"
