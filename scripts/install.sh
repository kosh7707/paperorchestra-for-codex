...
Usage:
  ./scripts/install.sh [--skip-skills] [--skip-mcp] [--skip-omx] [--dry-run]
...
write_provider_env() {
  {
    ...
    printf '# Override PAPERO_MODEL_CMD before running scripts/install.sh if you prefer a different shell provider.\n'
