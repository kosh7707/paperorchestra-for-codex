...
run_unittest_group validation_review \
  ...
  tests.test_jobs_and_pipeline.PipelineTests.test_section_and_citation_critic_cli_surfaces

run_unittest_group quality_loop \
  tests.test_audit_surface_invariants \
  tests.test_jobs_and_pipeline.PipelineTests.test_qa_loop_bridge_exit_codes_and_progress_delta \
  tests.test_jobs_and_pipeline.PipelineTests.test_qa_loop_step_runs_missing_citation_review_handler \
  tests.test_jobs_and_pipeline.PipelineTests.test_qa_loop_step_runs_tier0_precondition_refresh_handlers \
  tests.test_jobs_and_pipeline.PipelineTests.test_qa_loop_step_stops_on_unsupported_executable_action \
  tests.test_jobs_and_pipeline.PipelineTests.test_qa_loop_step_noops_on_terminal_human_needed_even_with_executable_action \
  tests.test_jobs_and_pipeline.PipelineTests.test_qa_loop_step_cli_passes_citation_provider_settings \
  tests.test_jobs_and_pipeline.PipelineTests.test_repair_citation_claims_restores_validation_pointer_on_compile_reject \
  tests.test_jobs_and_pipeline.PipelineTests.test_qa_loop_step_rolls_back_candidate_on_verification_exception
...
run_unittest_group omx_ralph_integration \
  ...
  tests.test_jobs_and_pipeline.PipelineTests.test_qa_loop_brief_contains_omx_handoff_and_no_success_verdict \
  tests.test_jobs_and_pipeline.PipelineTests.test_qa_loop_brief_prioritizes_executable_actions_over_human_needed_sidecars \
  tests.test_jobs_and_pipeline.PipelineTests.test_next_ralph_instruction_uses_supported_executable_action \
  tests.test_jobs_and_pipeline.PipelineTests.test_ralph_start_dry_run_cli_does_not_launch \
  tests.test_jobs_and_pipeline.PipelineTests.test_ralph_start_launch_calls_omx_ralph_explicitly
