...
from paperorchestra.loop_engine.quality.action_plan import citation_integrity, citation_quality, citation_support, claim_review, claim_safety, figure_grounding, preconditions, scholarly, source_material
...
def test_action_builders_facade_reexports_tier_helpers() -> None:
    ...
    assert claim_safety._append_high_risk_claim_actions is claim_review._append_high_risk_claim_actions
    assert claim_safety._append_planning_satisfaction_actions is claim_review._append_planning_satisfaction_actions
